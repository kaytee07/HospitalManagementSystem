...
public class HospitalManagementSystem {
    ...
    public static void main(String[] args) {
        ...
        boolean added = patientCRUD.addPatient(1, "Kwame", "Mensah", "0244000000", "Accra");
...
//        boolean updated = patientCRUD.updatePatient(1, "phone", "0200000000");
...
//            patientCRUD.updatePatient(1, "invalid_column", "value");
//        } catch (Exception e) {
//            System.out.println("Expected error: " + e.getMessage());
//        }
//
...
//            boolean deleted = patientCRUD.deletePatient(1);
